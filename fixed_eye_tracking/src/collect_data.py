...
def collect_gaze_data(duration=10):
    ...
    def gaze_data_callback(gaze_data):
        ...
        if left_eye and right_eye:
            ...
            timestamp = time.time()  # Alternatively, use gaze_data['system_time_stamp'] if available
            gaze_data_list.append((timestamp, avg_x, avg_y))
    ...
    # Save the collected gaze data to CSV
