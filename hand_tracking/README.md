...
<p align="center">
  <img src="images/angle.jpg" alt="Alt Text" width="400">
</p>
...
<p align="center">
  <img src="images/leap.jpg" alt="Leap Motion Controller" width="500">
</p>

The desk setup for utilizing the Leap Motion controller is depicted below:

<p align="center">
  <img src="images/desk.jpg" alt="Desk Setup with Leap Motion" width="500">
</p>

To achieve accuracy in calculating intersection points, it is essential to clearly mark the positions of the controller and the monitor on the desk. In our project, we used tapes to mark the precise locations, as shown in the example below:

<p align="center">
  <img src="images/mark.jpg" alt="Mark Positions" width="500">
</p>
